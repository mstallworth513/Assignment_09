...
# MStallworth, 2020-Sep-07, Modified code to add code to Track class and added methods
# MStallworth, 2020-Sep-07, Modified code for CD class and added code for adding and removing tracks 
#------------------------------------------#
...
class Track():
    ...
    # -- Constructor -- #
    def __init__(self, pos, ttl, lgth) -> None:
        """Set position, title and length of a new track"""
        # -- Attributes -- #
        try:
            self.__position = pos
            self.__title = ttl
